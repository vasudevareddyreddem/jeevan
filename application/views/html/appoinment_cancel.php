        ...
        <div role="tabpanel">
            <div class="col-sm-3" style="">
                <ul class="nav nav-pills brand-pills nav-stacked" role="">
                    ...
                    <li role="presentation" class="brand-nav active"><a href="<?php echo base_url('appointment/canceled'); ?>" aria-controls="tab4" role="tab" >Cancel Bookings</a></li>
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tab4">
						...
						<div class="loop">
							<div class="panel panel-default">
								<div class="panel-heading"><span class="site-col">Cancelation Id : <?php echo str_pad($li['a_b_id'], 5, "M0000", STR_PAD_LEFT); ?></span> <span class="pull-right site-col"> Distance : <?php echo number_format((float)$li['distance'], 2, '.', ''); ?> Km</span></div>
								<div class="panel-body">
									...
									<div class="col-md-5">
										<strong>Reason: </strong><?php echo isset($li['region'])?$li['region']:''; ?>
										<div class="mt-2">
