			...
			<div class="section-padding mt-4">
				...
				<table class="table table-bordered mt-4" style="width:100%">
					...
					<tr>
						<th>Time slot</th>	
						<td>
						<?php echo isset($a_data['a_date'])?$a_data['a_date']:''; ?>
