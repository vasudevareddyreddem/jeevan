                    ...
                    <div class="col-md-12" style="border-right: 1px dotted #C2C2C2;padding-right: 30px;">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="Registration">
                                <form action="<?php echo base_url('login/verify'); ?>" method="post" role="form" class="form-horizontal">
								<?php $csrf = array(
					...
					<input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" name="name" placeholder="Name"  value="<?php echo isset($u_d['name'])?$u_d['name']:''; ?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="email" class="col-sm-2 control-label">
                                        Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo isset($u_d['email'])?$u_d['email']:''; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="mobile" class="col-sm-2 control-label">
                                        Mobile</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile"  value="<?php echo isset($u_d['mobile'])?$u_d['mobile']:''; ?>"  required>
                                    </div>
                                </div>
